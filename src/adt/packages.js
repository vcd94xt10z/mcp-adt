...
export class PackageApi {
    ...
    async list({ query = "*", maxResults = 100 } = {}) {
        ...
        // Consulta os detalhes dos pacotes para obter descrição e superpackage.
        const enriched = await Promise.all(items.map(async item => {
            try {
                ...
                return {
                    ...
                    superPackage: detail.superPackage || item.superPackage || "",
                    softwareComponent: item.softwareComponent || detail.softwareComponent || "",
                    transportLayer: item.transportLayer || detail.transportLayer || ""
                };
            } catch {
                return item;
            }
